-- CreateEnum
CREATE TYPE "BadgeType" AS ENUM ('LIKE', 'YOU_ROCK');

-- CreateEnum
CREATE TYPE "BadgeCategory" AS ENUM ('DAY', 'WEEK', 'MONTH');

-- CreateEnum
CREATE TYPE "BadgeRank" AS ENUM ('FIRST', 'SECOND', 'THIRD');
...
-- CreateIndex
CREATE INDEX "Like_newsletter_id_user_id_idx" ON "Like"("newsletter_id", "user_id");
...
-- CreateIndex
CREATE INDEX "Newsletter_published_at_idx" ON "Newsletter"("published_at");

-- CreateIndex
CREATE INDEX "Newsletter_likes_count_idx" ON "Newsletter"("likes_count");

-- CreateIndex
CREATE INDEX "Newsletter_you_rocks_count_idx" ON "Newsletter"("you_rocks_count");

-- CreateIndex
CREATE INDEX "Newsletter_created_at_idx" ON "Newsletter"("created_at");

-- CreateIndex
CREATE INDEX "Newsletter_likes_count_created_at_idx" ON "Newsletter"("likes_count", "created_at");

-- CreateIndex
CREATE INDEX "Newsletter_you_rocks_count_created_at_idx" ON "Newsletter"("you_rocks_count", "created_at");

-- CreateIndex
CREATE INDEX "Newsletter_published_at_likes_count_idx" ON "Newsletter"("published_at", "likes_count");

-- CreateIndex
CREATE INDEX "Newsletter_published_at_you_rocks_count_idx" ON "Newsletter"("published_at", "you_rocks_count");
...
-- CreateIndex
CREATE INDEX "badges_newsletter_id_idx" ON "badges"("newsletter_id");

-- CreateIndex
CREATE INDEX "badges_type_category_rank_idx" ON "badges"("type", "category", "rank");

-- CreateIndex
CREATE INDEX "badges_earned_at_idx" ON "badges"("earned_at");

-- CreateIndex
CREATE UNIQUE INDEX "badges_type_category_rank_earned_at_key" ON "badges"("type", "category", "rank", "earned_at");
...
-- AddForeignKey
ALTER TABLE "badges" ADD CONSTRAINT "badges_newsletter_id_fkey" FOREIGN KEY ("newsletter_id") REFERENCES "Newsletter"("newsletter_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- Enable public read-only access for public content tables
